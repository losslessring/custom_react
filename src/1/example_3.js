...
/* Playground: */
var oldList = createElement(
    'ul',
    { className: 'some-list' },
    createElement('li', { className: 'some-list__item', key: 'one' }, 'One'),
    createElement('li', { className: 'some-list__item', key: 'two' }, 'Two')
)
var newList = createElement(
    ...
    createElement(
        'li',
        { className: 'some-list__item', key: 'three' },
        'Three'
    ),
    createElement('li', { className: 'some-list__item', key: 'two' }, 'Two')
)
